...
const applicationServerPublicKey =
  'BPKG6mdbOcsA_m_g4CUnEuVIQQhAm4KwJv3Hp8xCvy37VSDRURlROvw9QyS8Sr98Q-A_m3aexKy7ucUFaaR_jNA';
  ...
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
      navigator.serviceWorker
        .register('./service-worker-1.0.1.min.js')
        .then((reg) => {
          registration = reg;
          InitNoticeUI();
        });
...
function SwitchPage() {
  ...
  $('.js-menu-item[data-target="' + sessionStorage.Page + '"]').addClass(
    'active'
  );
  $(
    '.js-container-content[data-trigger="' + sessionStorage.Page + '"]'
  ).addClass('active');
